    ...
    <div class="min-h-screen">
        ...
        <form class="w-3/5 px-6 py-3 mt-8 ms-6 toright bg-white rounded-xl shadow-md" method="post"
            ...
            <div class="mb-5">
                ...
                block w-full p-2.5"
                    value="{{ old('name', $alternative->name) }}" name="name" placeholder="Masukan nama alternative">
                @error('name')
            ...
            <div class="mb-5">
                ...
                <input type="text" id="kode_alternative"
                    class="bg-gray-50 border @error('kode_alternative') border-red-500 @enderror
                           text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500
                           block w-full p-2.5"
                    value="{{ old('kode_alternative', $alternative->kode_alternative) }}" name="kode_alternative"
                    placeholder="Masukan nama alternative">

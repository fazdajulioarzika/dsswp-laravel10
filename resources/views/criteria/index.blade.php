...
@section('content')
    <div class="min-h-screen">
        <div
            ...
            <h1 class="text-3xl font-semibold text-white">Halaman Criteria</h1>
        </div>
                    ...
                    <div
                        ...
                        <div class="p-6 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent font-medium ">
                            <div class="flex items-center mb-2">
                                <h6 class="inline-block mx-3">Criteria table</h6>
                                <a href="/criteria/create"
                                    ...
                                    <i class="far fa-plus-square"></i> Add a Criteria
                                </a>
                                <form action="/criteria/search" method="GET" class="flex items-center ml-auto">

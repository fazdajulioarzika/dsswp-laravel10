    ...
    <div class="min-h-screen">
        <div
            ...
            <h1 class="text-3xl font-semibold text-white">
                Add Criteria Data</h1>
        </div>


        <form class="w-3/5 px-6 py-3 mt-8 ms-6 toright bg-white rounded-xl shadow-md" method="post" action="/criteria">
            @csrf
            <div class="mb-5">
                ...
                block w-full p-2.5"
                    value="{{ old('name') }}" name="name" placeholder="Masukan nama criteria">
                @error('name')
            ...
            <div class="mb-5">
                ...
                <input type="text" id="kode_criteria"
                    class="bg-gray-50 border @error('kode_criteria') border-red-500 @enderror
                           text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500
                           block w-full p-2.5"
                    value="{{ old('kode_criteria') }}" name="kode_criteria" placeholder="Masukan nama criteria">
                @error('kode_criteria')
                    <div class="text-red-500 text-sm m-1">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-5">
                ...
                <input type="text" id="weight"
                    class="bg-gray-50 border @error('weight') border-red-500 @enderror
                           text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500
                           block w-full p-2.5"
                    value="{{ old('weight') }}" name="weight" placeholder="Masukan bobot criteria">
                @error('weight')
                    <div class="text-red-500 text-sm m-1">
                        {{ $message }}
                    </div>
